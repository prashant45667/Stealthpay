    ...
    <div className="luxury-card rounded-3xl p-6 sm:p-8 space-y-6 relative overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/5">
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="inline-flex items-center space-x-1.5 px-3.5 py-1.5 rounded-full bg-onyx-950 hover:bg-onyx-900 text-onyx-300 hover:text-emerald-neon border border-white/10 text-xs font-mono transition"
      ...
      <div className="overflow-x-auto rounded-2xl border border-white/5 bg-onyx-950/60">
        <table className="w-full text-left text-xs font-mono">
          <thead className="bg-onyx-900/90 text-onyx-400 uppercase tracking-wider border-b border-white/5">
            <tr>
          ...
          <tbody className="divide-y divide-white/5">
            {history.map((batch) => {
              return (
                <tr key={batch.batchId} className="hover:bg-onyx-900/40 transition">
                  {/* Batch ID & Memo */}
                      ...
                      <div>
                        ...
                        <div className="text-[11px] text-onyx-400 flex items-center space-x-1 mt-0.5">
                          ...
                          <button
                            ...
                            className="text-onyx-500 hover:text-emerald-neon transition"
                          >
                  ...
                  {/* Status Badge */}
                  <td className="py-3.5 px-4">
                    <span className="inline-flex items-center space-x-1 px-2.5 py-0.5 rounded-full bg-emerald-neon/10 text-emerald-neon border border-emerald-neon/20 text-[10px] font-bold uppercase">
