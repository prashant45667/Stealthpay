...
export const DepositModal: React.FC<DepositModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-onyx-950/85 backdrop-blur-xl animate-fade-in">
      <div className="relative w-full max-w-md rounded-3xl luxury-card p-6 sm:p-8 overflow-hidden shadow-2xl border border-white/10">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-white/10">
          <div className="flex items-center space-x-2.5">
            <div className="p-2 rounded-xl bg-onyx-900 border border-emerald-neon/30 text-emerald-neon">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 my-6">
          <div className="p-3.5 rounded-2xl bg-onyx-950/90 border border-white/5 flex items-center justify-between text-xs font-mono">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-onyx-950 border border-white/10 text-white font-mono text-xl font-bold focus:outline-none focus:border-emerald-neon transition"
                placeholder="50000"
                required
              />
          ...
          <div className="grid grid-cols-4 gap-2 pt-1">
            {[25000, 50000, 100000, 250000].map((val) => (
              <button
                ...
                className="px-2 py-1.5 rounded-full bg-onyx-950 hover:bg-onyx-900 text-xs font-mono text-onyx-300 hover:text-white border border-white/5 transition"
              >
                +{val / 1000}k
              </button>
            ))}
          ...
          <div className="pt-4 flex items-center justify-end space-x-3 border-t border-white/5">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2.5 rounded-full bg-onyx-900 hover:bg-onyx-800 text-onyx-300 hover:text-white text-xs font-mono border border-white/5 transition"
            >
              Cancel
            </button>
            <button
              ...
              className="inline-flex items-center space-x-2 px-6 py-2.5 rounded-full bg-white text-onyx-950 font-bold font-mono text-xs shadow-pill hover:bg-neutral-200 transition disabled:opacity-50"
            >
